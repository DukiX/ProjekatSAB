...
public class PublicModuleTest {
	...
	public void test() {
		...
		BigDecimal amountWithDiscounts = shopAAmountWithDiscount.add(shopC2AmountWithDiscount)
				.add(shopC3AmountWithDiscount).setScale(3);
		...
		Assert.assertEquals(amountWithoutDiscounts.subtract(amountWithDiscounts),
				orderOperations.getDiscountSum(order));
